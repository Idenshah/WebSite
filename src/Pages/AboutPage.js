  ...
  return (
    <>
      ...
      <p className="aboutMe">
        ...
        offering insights into the path that led me to the dynamic field of web
        development.
      </p>
      ...
      <p className="aboutMe">
        ...
        databases effectively. I possess the flexibility to work across various
        operating systems, including Windows, Raspberry Pi, and Linux. In terms
        of data organization, I excel with MySQL. These skills showcase my
        commitment to continuous learning and hands-on experience, preparing me
        for the ever-evolving field of web development
      </p>
      <h3>Programming Languages and Platforms</h3>
      <ul className="aboutList">
        <li>
          <span className="listBold">Programming Languages: </span> JavaScript,
          C#, Python
        </li>
        <li>
      ...
      <dl className="aboutList">
        <span className="listBold"> Achievement: </span>I'm honored to have been
        listed on the Dean's List consistently throughout my academic career
      </dl>
      <h4>
        Master of Science in Petroleum Drilling and Extraction Engineering
      </h4>
      <li>Science and Research Azad University, (Tehran, Iran), 2011 - 2014</li>
      <dl>
      ...
      <div className="workList">
        ...
        <dl>
          • Collaborating with management to report inventory-related concerns.
        </dl>
      </div>
      ...
      <div className="workList">
        <dl>
          • Observed and evaluated the company's services, offering feedback to
          top management regarding outcomes and adherence to company regulations
